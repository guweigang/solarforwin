...
{
    /**
     * add an attribute to indicate which operation is
     * if it is sync, it will ignore target checking.
     *
     */
    ...
    /**
     * Returns the command to copy files on Windows system prior NT6
     *
     * @param string $src The source path of the real file.
     *
     * @param string $tgt The target path for where to put the symlink.
     ...
     *
     */
    protected static function _makeXP($src, $tgt, $dir)
    {
    	$cmd = '';
    	if ($dir) {
    		$cmd = "cd $dir & ";
    	}
    	// use external tool sync to sync file
    ...
    /**
     * Returns the command to romove and copy directores on Windows system prior NT6
     *
     * @param string $src The source path of the real file.
     *
     * @param string $tgt The target path for where to put the symlink.
